...
def load_all_models_mul():
    vectorizer = FullTextTfidfVectorizer()
    vectorizer.load(os.path.join("models/models_mul/logistic/", "vectorizer_binary.joblib"))

    model = TfidfLogisticModel()
    model.load(os.path.join("models/models_mul/logistic/", "logistic_binary.joblib"))
